...
export const portBlairHotel: Hotel = {
  ...
  thumbnailImage: '/images/hotels/port-blair/Sinclairs-Bayview-Lobby.jpg',
  amenities: [
  ...
  rooms: [
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Premier-Room.jpg',
    },
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Valentine-Room.jpg',
    },
    {
    ...
    },
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Premier-Family-Suite.jpg',
    },
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Premier-Family-Attic-Room.jpg',
    },
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Premier-Family-Suite-Attic.jpg',
    },
  ],
  dining: [
    {
      ...
      image: '/images/hotels/port-blair/Sinclairs-Bayview-The-Bayview-Restaurant.jpg',
    },
    {
      name: 'Alto Espirito',
      description: 'a bar with a relaxed old-world ambience, offering snacks and drinks.',
      image: '/images/hotels/port-blair/Sinclairs-Bayview-Alto-Espirito-Bar.jpg',
    },
    {
      name: 'The Terrace',
      description:
        'a covered sea-facing deck where meals can be served on request, with the sea breeze and the sound of waves.',
      image: '/images/hotels/port-blair/Sinclairs-Bayview-The-Terrace.jpg',
    },
  ],
  gallery: [
    {
    ...
    {
      src: '/images/hotels/port-blair/Sinclairs-Bayview-Lobby.jpg',
      alt: 'Sea-facing lounge with open verandah seating at Sinclairs Bayview',
    },
    {
      src: '/images/hotels/port-blair/Sinclairs-Bayview-The-Forum.jpg',
      alt: 'The Forum banquet hall set up for a conference at Sinclairs Bayview',
    },
    {
      src: '/images/hotels/port-blair/Sinclairs-Bayview-Facade-Night.jpg',
