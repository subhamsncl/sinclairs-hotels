...
export const gangtokHotel: Hotel = {
  ...
  heroImage: '/images/hotels/gangtok/destination/Sinclairs-Gangtok-Facade.jpg',
  thumbnailImage: '/images/hotels/gangtok/destination/Sinclairs-Gangtok-with-Pool.jpg',
  amenities: [
  ...
  rooms: [
    {
      ...
      images: ['/images/hotels/gangtok/accommodations/Sinclairs-Gangtok-Deluxe-Room.jpg'],
    },
    {
      ...
      images: ['/images/hotels/gangtok/accommodations/Sinclairs-Gangtok-Deluxe-Family-Room.jpg'],
    },
    {
      name: 'Premier Room',
      description:
      ...
      images: ['/images/hotels/gangtok/accommodations/Sinclairs-Gangtok-Premier-Room.jpg'],
    },
    {
      name: 'Premier Suite',
      description:
      ...
      images: ['/images/hotels/gangtok/accommodations/Sinclairs-Gangtok-Premier-Suite.jpg'],
    },
    {
      name: 'Valentine Room',
      description:
      ...
      images: ['/images/hotels/gangtok/accommodations/Sinclairs-Gangtok-Valentine-Room.jpg'],
    },
  ],
  dining: [
    {
      ...
      image: '/images/hotels/gangtok/dining/Sinclairs-Gangtok-Magnolia-Restaurant.jpg',
    },
    {
      ...
      image: '/images/hotels/gangtok/dining/Sinclairs-Gangtok-Guras-Bar-Lounge.jpg',
    },
  ],
  gallery: [
    {
      src: '/images/hotels/gangtok/destination/Sinclairs-Gangtok-with-Pool.jpg',
      alt: 'Sinclairs Gangtok exterior with the outdoor swimming pool',
    },
    {
      src: '/images/hotels/gangtok/gallery/Sinclairs-Gangtok-Pool-Deck.jpg',
      alt: 'Guests relaxing at the rooftop pool deck at Sinclairs Gangtok',
    },
    {
      src: '/images/hotels/gangtok/gallery/Sinclairs-Gangtok-Reception.jpg',
      alt: 'Reception lobby at Sinclairs Gangtok',
    },
    {
      src: '/images/hotels/gangtok/gallery/Sinclairs-Gangtok-Cherry-Hall.jpg',
      alt: 'The Cherry Hall set up for a conference at Sinclairs Gangtok',
    },
  ],
  sightseeing: [
    'Tashi View Point',
