    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 text-cream">
          <p className="text-xs uppercase tracking-widest text-gold-light drop-shadow">
            {hotel.location}, {hotel.state}
          </p>
          <h3 className="mt-1 font-display text-2xl drop-shadow-md">{hotel.name}</h3>
          <p className="mt-2 line-clamp-2 text-sm text-cream/80">{hotel.tagline}</p>
          <div className="mt-4 flex gap-4 border-t border-cream/20 pt-3 text-xs text-cream/70">
            <span>
